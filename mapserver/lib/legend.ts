  ...
  return {
    ...
    geojson: {
      ...
      geometry: {
        type: "LineString",
        coordinates: [
          [reverse ? 0.00018 : -0.00018, reverse ? 0.00004 : -0.00004].map(
            (x) => x * factor
          ),
          [reverse ? -0.00018 : 0.00018, reverse ? -0.00004 : 0.00004].map(
            (x) => x * factor
...
function landcover(
  type: string,
  names: [en: string, sk: string, it: string],
  skew = true
) {
  return {
  ...
  items: [
    ...
    ...["", 1, 2, 3, 4, 5].map((grade) => ({
      ...
      name: {
        en:
          "track " +
          (grade ? `(grade ${grade})` : "(unknown grade)") +
          (grade === 1 ? ", service road" : ""),
    ...
    road(
      "footway",
      "sidewalk, platform, pedestrian",
      "chodník, nástupište, pešia zóna",
      "sentiero"
    ),
    ...
    road(
      "path",
      "good trail visibility",
      "viditeľnosť trasy je dobrá",
      "buona visibilità della traccia",
      false,
      1
    ),
    road(
    ...
    road(
      "path",
      "trail is not visible at all",
      "trasa nie je vôbec viditeľná",
      "traccia non visibile",
      false,
      5
    ),
    {
    ...
    poi(
      ...
      "weather_shelter",
      "weather shelter",
      "prístrešok pre nepriaznivé počasie",
      "riparo"
    ),
    poi(
      "accomodation",
    ...
    poi(
      "water",
      "not_drinking_spring",
      "not drinkable spring",
      "prameň úžitkovej vody",
      "sorgente non potabile",
      true
    ),
    poi(
      "water",
    ...
    poi(
      ...
      "school",
      "škola",
      "school" /* TODO translate */
    ),
    poi(
      "institution",
      "college",
      "college",
      "vysoká škola, gymnázium",
      "college" /* TODO translate */
    ),
    poi(
      "institution",
      "university",
    ...
    poi(
      ...
      "station",
      "train station, halt",
      "vlaková stanica, zastávka",
      "stazione treni, fermata"
    ),
    poi(
      "poi",
      "bus_station",
    ...
    },
    {
      ...
      layers: [
        asArea(["water_area", "water_area_names"], { name: "Abc", tmp: 1 }),
      ],
      ...props,
    },
    ...
    landcover("marsh", [
      "marsh, fen, wet meadow",
      "močiar, slatinisko, mokrá lúka",
      "palude, prateria umida",
    ]),
    ...
    landcover("residential", [
      "residential zone",
      "obytná zóna",
      "zona residenziale",
    ]),
    landcover("commercial", [
      "commercial zone",
      "komerčná zóna",
      "zona commerciale",
    ]),
    landcover("industrial", [
      "industrial zone, wastewater plant",
      "industriálna zóna, ČOV",
      "zona industriale",
    ]),
    ...
    ),
    {
      ...
      layers: [
        asArea(
          ["landcover", "features", "feature_names"],
          { type: "parking", name: "Abc" },
          18,
          false
        ),
      ],
    ...
    },
    {
      ...
      layers: [
        asArea(["buildings", "building_names"], { name: "Abc" }, 18, false),
      ],
      ...props,
    },
    {
      ...
      layers: [
        asArea(
          ["buildings", "features", "feature_names"],
          { type: "ruins", name: "Abc" },
          18,
          false
        ),
